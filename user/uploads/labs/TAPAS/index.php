...
<body>
    <div class="imgbox">
        ...
        <button id="closeBtn" data-chapter-id="52" style="top: 3.5%; left: 85.2%; width: 6%; height: 12.8%;" 
        onclick="window.location.href='../complete/vlabcompletion.php?lesson_id=3'"></button>
